"""
Title: rec_loader.py
Description: The loader classes for the reconstruction model.
Author: Lek'Sai Ye, University of Chicago
"""

from torch.utils.data import DataLoader
from rec_dataset import RecDataset, RecDatasetUnsupervised, RecDatasetEval
...
class RecLoader:
    def __init__(self,
        ...
        self.train_set = RecDataset(root,
                                    normal_folder,
                                    abnormal_folder,
                                    train=1)
        print('\nHi! I am setting testing set for you.')
        self.test_set = RecDataset(root,
                                   normal_folder,
                                   abnormal_folder,
                                   train=0)
    def loaders(self,
...
# --------------------------------------------
class RecLoaderUnsupervised:
    def __init__(self,
                 root: str='/net/adv_spectrum/torch_data_deepsad/100',
                 normal_folder: str='downtown'):

        print('Hi! I am setting train_set for you.')
        self.train_set = RecDatasetUnsupervised(root,
                                                normal_folder,
                                                True)
        print('\nHi! I am setting test_set for you.')
        self.test_set = RecDatasetUnsupervised(root,
                                               normal_folder,
                                               False)
...
class RecLoaderEval:
    def __init__(self,
        ...
        self.all_set = RecDatasetEval(root)
