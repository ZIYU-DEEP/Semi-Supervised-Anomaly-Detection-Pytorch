...
normal_file = str(sys.argv[1])  # 'downtown_big_normal'
abnormal_file = str(sys.argv[2])  # 'downtown_sigOver_10ms_big_abnormal'
df_name = str(sys.argv[3])  # 'downtown_big_sigOver_10ms_half'
test_list_filename = str(sys.argv[4])  # 'downtown_test_list.npy'
device_no = str(sys.argv[5])  # 1
eta_str = int(sys.argv[6]) # 50
n_epochs = int(sys.argv[7]) # 200
...
out_path = './{}'.format(df_name)
txt_result_file = './full_results.txt'
model_path = out_path + '/model_{}_{}_{}_{}.tar'.format(net_name, df_name, n_epochs, eta_str)
results_path = out_path + '/results_{}_{}_{}_{}.json'.format(net_name, df_name, n_epochs, eta_str)
cut_path = out_path + '/cut_{}_{}_{}_{}.npy'.format(net_name, df_name, n_epochs, eta_str)
...
result_df_path = '{}/result_df_{}_{}_{}_{}.pkl'.format(out_path, net_name, df_name, n_epochs, eta_str)
