...
[Example Command:]
python folder_to_xs_save.py --model forecast -nf 871 -af 871_ab_sigOver_5ms --overlap False --train 1
python folder_to_xs_save.py --model forecast -nf 871 -af 871_ab_sigOver_5ms --overlap False --train 0
python folder_to_xs_save.py --model forecast -nf 871 --train 1
python folder_to_xs_save.py --model forecast -nf 871 --train 0

python folder_to_xs_save.py --model forecast -nf campus_drive -af campus_drive_sigOver_10ms --overlap False --train 1
python folder_to_xs_save.py --model forecast -nf campus_drive -af campus_drive_sigOver_10ms --overlap False --train 0
...
window_size, predict_size, overlap  = p.window_size, p.predict_size, p.overlap
n_features, train_portion, train = p.n_features, p.train_portion, p.train
...
if model == 'deepsad':
    ...
    folder_to_Xs_save(path, path_, window_size, predict_size, overlap, n_features, train_portion, train)
