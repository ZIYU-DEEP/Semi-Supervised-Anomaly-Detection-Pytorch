...
python save_abnormal_xs.py --model forecast -nf campus_drive -af campus_drive_NLOS-5M-USRP1
python save_abnormal_xs.py --model forecast -nf campus_drive -af campus_drive_Dynamics-5M-USRP1
"""
...
if model == 'deepsad':
    ...
    save_abnormal_Xs(path, path_, window_size, predict_size, overlap, n_features)
