...
class GRUNetStacked(BaseNet):
    def __init__(self):
        ...
        self.gru1 = nn.LSTM(128, 64, num_layers=1, batch_first=True)
        self.BN1 = nn.BatchNorm1d(100)
        self.gru2 = nn.LSTM(64, 64, num_layers=1, batch_first=True)
        self.BN2 = nn.BatchNorm1d(100)
        self.gru3 = nn.LSTM(64, 64, num_layers=1, batch_first=True)
