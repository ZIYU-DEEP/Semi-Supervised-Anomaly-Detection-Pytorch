...
python main.py -ln rec -le rec_eval -nt rec -op rec_unsupervised -nf downtown -af downtown_sigOver_10ms -rt /net/adv_spectrum/torch_data_deepsad/100 -gpu 1
...
python main.py -ln rec -le rec_eval -nt rec -op rec_unsupervised -nf ryerson_train -af ryerson_ab_train_sigOver_10ms -rt /net/adv_spectrum/torch_data_deepsad/100 -gpu 1
